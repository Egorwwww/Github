...
from PyQt5.QtWidgets import QApplication, QRadioButton, QLabel, QButtonGroup, QPushButton, QVBoxLayout, QWidget, QSpinBox
...
q1 = Question('Кіт', 'cat', 'cut', 'cot', 'cart')  
q2 = Question('Місто', 'city', 'citrus', 'cite', 'citizen')  
q3 = Question('Річка', 'river', 'rival', 'ride', 'rice')  
q4 = Question('Дерево', 'tree', 'true', 'treat', 'trend')
q5 = Question('Ніч','night','neght','niht','nich')
q6 = Question('Сонце', 'sun', 'son', 'soon', 'sunny')  
q7 = Question('Книга', 'book', 'bock', 'boke', 'brook')  
q8 = Question('Автомобіль', 'car', 'care', 'card', 'cat')  
q9 = Question('Гори', 'mountains', 'mountian', 'mount', 'moun')  
q10 = Question('Мова', 'language', 'languag', 'langue', 'languge')
q11 = Question('Миша','mouse','muse','mause','mose')
q12=Question('голова','head','had','heod','heat') 
